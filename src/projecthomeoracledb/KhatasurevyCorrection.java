 ...
 * @author Deval Nayak
 */
public class KhatasurevyCorrection extends javax.swing.JFrame {

    /**
     * Creates new form KhatasurevyCorrection
     */
    public KhatasurevyCorrection() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhatasurevyCorrection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KhatasurevyCorrection().setVisible(true);
            }
        });
    }
